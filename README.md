...
- dodać ikonkę EDIT, której kliknięcie w miejscu rekordu ze splitem pokaże mały jedno liniowy formularz edycji splitu.
 ...
 - dodatkowa kolumna Procent z wartością widoczną tylko jeśli nie użyliśmy filtra kont.
...
3. Podsumowanie wartości
	Nad tabelką powinna być wartość wynikająca z obecnie ustawionego filtra
...
<span style="color:green">- Pojawi się formularz z polami tekstowymi pod nazwę , opis i wartość oraz DatePicer do wybrania daty.</span>
<span style="color:green">- Będzie też DropDown z wyborem budżetu z listy, domyślnie ustawiony na bieżący Budżet (na podstawie aktualnej daty)</span>
...
<span style="color:yellow">- Datapicker zawsze domyślnie dostanie bieżącą datę, ale oczywiście z możliwością zmiany</span>
